...
public class AdvertisementSelectedAdapter extends ArrayAdapter<AdvertisementInfo> {
    ...
    public AdvertisementSelectedAdapter(AppCompatActivity activity, int resource, ArrayList<AdvertisementInfo> advertisementInfoList) {
